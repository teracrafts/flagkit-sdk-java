...
public enum ErrorCode {
    ...
    // Security errors
    SECURITY_PII_DETECTED("SECURITY_PII_DETECTED", false),
    SECURITY_SIGNATURE_INVALID("SECURITY_SIGNATURE_INVALID", false),
    SECURITY_SIGNATURE_EXPIRED("SECURITY_SIGNATURE_EXPIRED", false),
    SECURITY_ENCRYPTION_FAILED("SECURITY_ENCRYPTION_FAILED", false),
    SECURITY_DECRYPTION_FAILED("SECURITY_DECRYPTION_FAILED", false),
    SECURITY_BOOTSTRAP_INVALID("SECURITY_BOOTSTRAP_INVALID", false),
    SECURITY_BOOTSTRAP_EXPIRED("SECURITY_BOOTSTRAP_EXPIRED", false),
    SECURITY_KEY_DERIVATION_FAILED("SECURITY_KEY_DERIVATION_FAILED", false);
